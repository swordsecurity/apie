...
class test_parser_file(TestCase):
    ...
    def test_parser_file(self):
        filename = dirname(abspath(__file__)) + "/assets/testfile.yaml"
        apie.parser.parseFile(filename)
        self.assertTrue(True)

    def test_parser_filewithouturl(self):
        filename = dirname(abspath(__file__)) + "/assets/filewithouturl.yaml"
        result = None
    ...
    def test_parser_filewithouttests(self):
        filename = dirname(abspath(__file__)) + "/assets/filewithouttests.yaml"
        result = None
    ...
    def test_parser_filewithoutpath(self):
        filename = dirname(abspath(__file__)) + "/assets/filewithoutpath.yaml"
        result = None
    ...
    def test_parser_filewithoutname(self):
        filename = dirname(abspath(__file__)) + "/assets/filewithoutname.yaml"
        result = None
    ...
    def test_parser_filewithoutexpected(self):
        filename = dirname(abspath(__file__)) + "/assets/filewithoutexpected.yaml"
        result = None
    ...
    def test_parser_filewithoutrequest(self):
        filename = dirname(abspath(__file__)) + "/assets/filewithoutrequest.yaml"
        result = None
